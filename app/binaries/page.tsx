...
import { FileCode2, Download, Key, RefreshCw, Search, Trash2, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      <NavigationLayout>
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Binaries</h1>
              <p className="text-muted-foreground">
                Manage your protected binary files
              </p>
            </div>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      ...
                      <TableRow 
                        ...
                        className="cursor-pointer hover:bg-muted/50"
                        onClick={() => router.push(`/binaries/${binary.binary_id}`)}
                      >
                              ...
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button 
                                    ...
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      router.push(`/binaries/${binary.binary_id}`);
                                    }}
                                  >
