            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-baseline gap-3">
                  <h1 className="text-3xl font-bold tracking-tight">{binary.original_name}</h1>
                  <span className="text-lg text-muted-foreground">({formatBytes(binary.original_size)})</span>
                </div>
                <p className="text-muted-foreground mt-1">Binary ID: {binary.binary_id}</p>
                {binary.description && (
                  <p className="text-sm text-muted-foreground mt-1">{binary.description}</p>
                )}
              </div>
            </div>
            <div className="flex gap-2">
              <Button onClick={handleDeleteBinary} variant="destructive" className="gap-2">
